...
---
## 1. 목적
본 문서는 3차 마이그레이션이 완료된 시점에서 고객이 Excel 양식에 입력한 데이터를 VCworks 화면 내에서 확인 하는 방법을 안내 하기 위해 작성된 문서입니다.
...
### 2-1. 거래 데이터 식별
거래 데이터는 아래의 데이터 묶음을 통해 식별이 가능합니다.
 - 회사명
 - 조합명
 - 투자유형
 - 최초거래일 (※투자심의를 통해 투자 거래가 진행된 경우 납입일이 최초거래일이 됩니다)
 - 거래일
 - 거래유형
