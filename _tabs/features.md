...
<div class="card categories">
  ...
  <div id="l_5" class="collapse" aria-expanded="false">
    <ul class="list-group">
      ...
      <li class="list-group-item">
        <i class="far fa-folder fa-fw"></i>
        <span class="mx-2">전자결재 상세</span>
      </li>
      <li class="list-group-item">
        <i class="far fa-folder fa-fw"></i>
        <span class="mx-2">전체 문서함</span>
      </li>
      <li class="list-group-item">
        <i class="far fa-folder fa-fw"></i>
        <span class="mx-2">받은 문서함</span>
      </li>
      <li class="list-group-item">
        <i class="far fa-folder fa-fw"></i>
        <span class="mx-2">보낸 문서함</span>
      </li>
      <li class="list-group-item">
        <i class="far fa-folder fa-fw"></i>
        <span class="mx-2">전자 결재 설정</span>
      </li>
    </ul>
  </div>
</div>
...
<div class="card categories">
  ...
  <div id="l_6" class="collapse" aria-expanded="false">
    <ul class="list-group">
      ...
      <li class="list-group-item">
        <i class="far fa-folder fa-fw"></i>
        <span class="mx-2">사용자 정의 항목 관리</span>
      </li>
      <li class="list-group-item">
        <i class="far fa-folder fa-fw"></i>
