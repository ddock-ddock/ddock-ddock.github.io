...
# 목적
투자 심의는 포트폴리오로 편입되기 전 투자 심의 중인 회사들에 대해서 정보 관리를 목적의 메뉴입니다. 투자 심의가 각 심의 단계를 거쳐서 투자 완료 상태가 되었을 때 포트폴리오 메뉴에 자동으로 편입됩니다.
...
## 투어 가이드
### 1. 조회 및 등록
- 투자심의 화면을 조회하고, 투자심의 카드(거래처)를 생성하는 방법에 대한 설명입니다.

<div style="position: relative; box-sizing: content-box; max-height: 80vh; max-height: 80svh; width: 100%; aspect-ratio: 1.7777777777777777; padding: 40px 0 40px 0;"><iframe src="https://app.supademo.com/embed/cmfun3joa1ih410k8le38849o?embed_v=2&utm_source=embed" loading="lazy" title="VCworks 투자심의 - 칸반조회 및 카드등록" allow="clipboard-write" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>

### 2. 회사정보/담당심사역/투자정보 입력
- 투자심의 카드 생성 후, 해당 회사의 기본 정보를 입력하는 단계에 대한 설명입니다.

<div style="position: relative; box-sizing: content-box; max-height: 80vh; max-height: 80svh; width: 100%; aspect-ratio: 1.7777777777777777; padding: 40px 0 40px 0;"><iframe src="https://app.supademo.com/embed/cmfvxd0ss2p1410k86nt69v0w?embed_v=2&utm_source=embed" loading="lazy" title="투자심의 - 회사정보/담당심사역/투자정보 입력" allow="clipboard-write" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>

### 3. 단계 이동 및 투자심의위원회 개최
- 투자심의 단계 이동과 예비투자심의/본투자심의 위원회 개최 방법에 대한 설명입니다.

<div style="position: relative; box-sizing: content-box; max-height: 80vh; max-height: 80svh; width: 100%; aspect-ratio: 1.7777777777777777; padding: 40px 0 40px 0;"><iframe src="https://app.supademo.com/embed/cmfw6ltl42vlm10k878sy867j?embed_v=2&utm_source=embed" loading="lazy" title="투자심의 - 단계 이동 및 투자심의위원회 개최" allow="clipboard-write" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>

### 4. 계약품의
- 회사 내부에서 투자심의 건에 대한 품의를 올리는 방법에 대한 설명입니다.

<div style="position: relative; box-sizing: content-box; max-height: 80vh; max-height: 80svh; width: 100%; aspect-ratio: 1.7777777777777777; padding: 40px 0 40px 0;"><iframe src="https://app.supademo.com/embed/cmfwavb3p31q010k85ulbp9ga?embed_v=2&utm_source=embed" loading="lazy" title="투자심의 - 계약품의" allow="clipboard-write" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>

### 5. 납입 단계 및 운용지시서
- 계약품의까지 완료된 후, 납입 단계에서 운용지시서를 작성하는 방법입니다.

<div style="position: relative; box-sizing: content-box; max-height: 80vh; max-height: 80svh; width: 100%; aspect-ratio: 1.7777777777777777; padding: 40px 0 40px 0;"><iframe src="https://app.supademo.com/embed/cmfwb1oow324o10k8kmm4s08a?embed_v=2&utm_source=embed" loading="lazy" title="투자심의 - 납입과 운용지시서" allow="clipboard-write" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>

> 본계정 유형인 조합(재원)의 경우, 운용지시서를 생성하지 않아도 등기 단계로 이동이 가능합니다.
{: .prompt-tip }

### 6. 등기 및 투자 완료
- 운용지시까지 완료된 후, 등기 단계로 이동할 때 진행되는 흐름에 대한 설명입니다.

<div style="position: relative; box-sizing: content-box; max-height: 80vh; max-height: 80svh; width: 100%; aspect-ratio: 1.7777777777777777; padding: 40px 0 40px 0;"><iframe src="https://app.supademo.com/embed/cmfwbbevn32e710k89jrsjz9k?embed_v=2&utm_source=embed" loading="lazy" title="투자심의 - 등기 및 투자완료" allow="clipboard-write" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>

### 7. 첨부파일
- 첨부파일 관련 가이드는 아래 문서를 확인하세요.
  - [투자심의 - 첨부파일 탭 설명 문서](https://guide.vcworks.kr/posts/vs0009/)


## 이용방법 (글)
투자 심의 메뉴 이용 방법은 크게, 1.등록, 2.조회, 3.투자 심의 진행 으로 분류 되며,\
각각 이용 방법에 대해서 아래에 카테고리 별로 설명 드립니다.
...
> 투자심의 완료 이후에 담당자가 퇴사하게 되면 수정이 가능한가요?
...
3. **이메일 통해 링크 접속**
	- 발신 주소: `no-reply@ddockddock.net`
	- 메일 제목: "예비/본투자심의위원회 의견서 작성 요청"
	- 받은 편지함에 없는 경우 **스팸 메일함을 반드시 확인**해주세요.
	![3](/assets/img/3.png)
4. **의견서 작성**
	- 메일 본문의 **[의견서 작성]** 버튼을 클릭합니다.
	- VCworks **등록 사용자**: VCworks 로그인 화면으로 이동 → 로그인 후 의견서 작성 화면으로 진입합니다.
	- VCworks **미등록 외부인**(사외 이사, 외부 자문위원 등): **[식별 코드 요청]** 버튼을 클릭해 이메일 기반 인증을 진행한 뒤 의견서 작성 화면으로 진입합니다.
	- 찬반 여부, 의견, 서명을 입력해주세요.
	    - VCworks 계정이 있는 경우 [마이페이지(my0001)](/posts/my0001/)에 등록된 서명이 자동으로 불러와집니다.
	![4](/assets/img/4.png)
5. **의견서 제출 Click**
	![5](/assets/img/5.png)
6. **완료**
    - 제출된 의견은 예비/본 투자심의 화면에서 바로 확인할 수 있습니다.

> **이메일 투표 방식이 유용한 상황**
{: .prompt-tip }
- VCworks에 계정이 없는 **외부 심사위원/사외 이사**가 의견을 제출해야 하는 경우
- PC로 VCworks에 접속할 수 없는 환경(출장·원격 등)에서 의견 제출이 필요한 경우
